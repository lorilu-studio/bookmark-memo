...
[SuperSocket 2.0 | 轻量级的可扩展的 Socket 开发框架](https://docs.supersocket.net/v2-0/zh-CN)

[Jeepay | 互联网企业开源支付系统](https://www.jeequan.com/)

[XXLJob | 分布式任务调度平台](https://www.xuxueli.com/xxl-job/)

[Nacos | Alibaba开源配置管理与服务管理平台](https://nacos.io/zh-cn/docs/what-is-nacos.html)

[Hutool | Hutool是一个小而全的Java工具类库](https://hutool.cn/docs/#/)


## 其他


[GPS Visualizer | 在线实时程序，用地理数据创建地图和配置文件](https://www.gpsvisualizer.com/)

[DPlayer | 弹幕视频播放器](https://dplayer.diygod.dev/)

[数字孪生 | 数据可视化太极开发者平台](https://www.gbim.vip/#/home/main)



## 影视资源

[555 电影网](https://55xa1.art/)
